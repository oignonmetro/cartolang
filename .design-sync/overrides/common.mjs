// forked from design-sync lib/common.mjs — adds `srcExclude` to CONFIG_KEYS
// so validateConfig accepts it (paired with the source-kit.mjs fork, which
// reads it). See that fork's header for why the key exists.
//
...
export const CONFIG_KEYS = new Set([
  ...
  // cartolang fork (source-kit.mjs): file basenames excluded from the
  // synth-entry barrel outright — see .design-sync/overrides/source-kit.mjs
  'srcExclude',
  // curation + docs
